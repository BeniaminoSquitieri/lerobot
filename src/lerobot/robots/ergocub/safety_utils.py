...
class HandSafetyChecker:
    ...
    def is_valid_action(self, action: Dict[str, Any], arms_to_check: list[str] | None = None) -> bool:
        """
    ...
    def check_hand_position_safety(
        self, action: Dict[str, Any], current_state: Dict[str, Any], arms_to_check: list[str] | None = None
    ) -> bool:
        """
