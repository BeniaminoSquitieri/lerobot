...
from lerobot_bt_python.config import SkillCommandServerConfig
...
def _make_server(*, known_skill_names: set[str] | None = None):
    ...
    from lerobot_bt_python.server import SkillCommandServer
...
def test_parser_wrap_sees_dataclass_config_annotation() -> None:
    from lerobot_bt_python.server import run
