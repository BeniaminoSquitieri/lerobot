...
#ifndef SANDWICH_BT_INTERFACES__SRV__DETAIL__PLAN_NEXT_STEP__FUNCTIONS_H_
#define SANDWICH_BT_INTERFACES__SRV__DETAIL__PLAN_NEXT_STEP__FUNCTIONS_H_
...
/// Initialize srv/PlanNextStep message.
/**
 ...
 * )) before or use
 * sandwich_bt_interfaces__srv__PlanNextStep_Request__create()
...
/// Finalize srv/PlanNextStep message.
/**
...
/// Create srv/PlanNextStep message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sandwich_bt_interfaces__srv__PlanNextStep_Request__init().
...
/// Destroy srv/PlanNextStep message.
/**
 * It calls
 * sandwich_bt_interfaces__srv__PlanNextStep_Request__fini()
...
/// Check for srv/PlanNextStep message equality.
/**
...
/// Copy a srv/PlanNextStep message.
/**
...
/// Initialize array of srv/PlanNextStep messages.
/**
...
/// Finalize array of srv/PlanNextStep messages.
/**
 * It calls
 * sandwich_bt_interfaces__srv__PlanNextStep_Request__fini()
...
/// Create array of srv/PlanNextStep messages.
/**
 * It allocates the memory for the array and calls
 * sandwich_bt_interfaces__srv__PlanNextStep_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/PlanNextStep messages.
/**
 * It calls
 * sandwich_bt_interfaces__srv__PlanNextStep_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/PlanNextStep message array equality.
/**
...
/// Copy an array of srv/PlanNextStep messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * sandwich_bt_interfaces__srv__PlanNextStep_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_sandwich_bt_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sandwich_bt_interfaces__srv__PlanNextStep_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sandwich_bt_interfaces
...
/**
 * It calls
 * sandwich_bt_interfaces__srv__PlanNextStep_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_sandwich_bt_interfaces
...
/**
 * It allocates the memory for the array and calls
 * sandwich_bt_interfaces__srv__PlanNextStep_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sandwich_bt_interfaces
...
/**
 * It calls
 * sandwich_bt_interfaces__srv__PlanNextStep_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * sandwich_bt_interfaces__srv__PlanNextStep_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_sandwich_bt_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * sandwich_bt_interfaces__srv__PlanNextStep_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sandwich_bt_interfaces
...
/**
 * It calls
 * sandwich_bt_interfaces__srv__PlanNextStep_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_sandwich_bt_interfaces
...
/**
 * It allocates the memory for the array and calls
 * sandwich_bt_interfaces__srv__PlanNextStep_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_sandwich_bt_interfaces
...
/**
 * It calls
 * sandwich_bt_interfaces__srv__PlanNextStep_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SANDWICH_BT_INTERFACES__SRV__DETAIL__PLAN_NEXT_STEP__FUNCTIONS_H_
