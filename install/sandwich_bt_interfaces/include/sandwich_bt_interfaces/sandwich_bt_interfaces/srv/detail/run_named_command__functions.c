...
sandwich_bt_interfaces__srv__RunNamedCommand_Request__init(sandwich_bt_interfaces__srv__RunNamedCommand_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->kind)) {
    sandwich_bt_interfaces__srv__RunNamedCommand_Request__fini(msg);
    return false;
  }
  // name
...
sandwich_bt_interfaces__srv__RunNamedCommand_Request__create(void)
{
  ...
  sandwich_bt_interfaces__srv__RunNamedCommand_Request * msg = (sandwich_bt_interfaces__srv__RunNamedCommand_Request *)allocator.allocate(sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Request));
  bool success = sandwich_bt_interfaces__srv__RunNamedCommand_Request__init(msg);
  if (!success) {
...
sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence__init(sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sandwich_bt_interfaces__srv__RunNamedCommand_Request * data = NULL;

  if (size) {
    data = (sandwich_bt_interfaces__srv__RunNamedCommand_Request *)allocator.zero_allocate(size, sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sandwich_bt_interfaces__srv__RunNamedCommand_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sandwich_bt_interfaces__srv__RunNamedCommand_Request__fini(&data[i - 1]);
      }
...
sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence__fini(sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sandwich_bt_interfaces__srv__RunNamedCommand_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence * array = (sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence *)allocator.allocate(sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence__init(array, size);
  if (!success) {
...
sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence__destroy(sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence__are_equal(const sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence * lhs, const sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sandwich_bt_interfaces__srv__RunNamedCommand_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sandwich_bt_interfaces__srv__RunNamedCommand_Request * data =
      (sandwich_bt_interfaces__srv__RunNamedCommand_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sandwich_bt_interfaces__srv__RunNamedCommand_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sandwich_bt_interfaces__srv__RunNamedCommand_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sandwich_bt_interfaces__srv__RunNamedCommand_Request__copy(
...
sandwich_bt_interfaces__srv__RunNamedCommand_Response__init(sandwich_bt_interfaces__srv__RunNamedCommand_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->status)) {
    sandwich_bt_interfaces__srv__RunNamedCommand_Response__fini(msg);
    return false;
  }
  // elapsed_s
  // message
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sandwich_bt_interfaces__srv__RunNamedCommand_Response * msg = (sandwich_bt_interfaces__srv__RunNamedCommand_Response *)allocator.allocate(sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Response));
  bool success = sandwich_bt_interfaces__srv__RunNamedCommand_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence__init(sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sandwich_bt_interfaces__srv__RunNamedCommand_Response * data = NULL;

  if (size) {
    data = (sandwich_bt_interfaces__srv__RunNamedCommand_Response *)allocator.zero_allocate(size, sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sandwich_bt_interfaces__srv__RunNamedCommand_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        sandwich_bt_interfaces__srv__RunNamedCommand_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence__fini(sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      sandwich_bt_interfaces__srv__RunNamedCommand_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence * array = (sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence *)allocator.allocate(sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence__destroy(sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence__are_equal(const sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence * lhs, const sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sandwich_bt_interfaces__srv__RunNamedCommand_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sandwich_bt_interfaces__srv__RunNamedCommand_Response * data =
      (sandwich_bt_interfaces__srv__RunNamedCommand_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sandwich_bt_interfaces__srv__RunNamedCommand_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sandwich_bt_interfaces__srv__RunNamedCommand_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!sandwich_bt_interfaces__srv__RunNamedCommand_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
sandwich_bt_interfaces__srv__RunNamedCommand_Event__init(sandwich_bt_interfaces__srv__RunNamedCommand_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    sandwich_bt_interfaces__srv__RunNamedCommand_Event__fini(msg);
    return false;
  }
  // request
  if (!sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence__init(&msg->request, 0)) {
    sandwich_bt_interfaces__srv__RunNamedCommand_Event__fini(msg);
    return false;
  }
  // response
  if (!sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence__init(&msg->response, 0)) {
    sandwich_bt_interfaces__srv__RunNamedCommand_Event__fini(msg);
    return false;
  }
  return true;
...
sandwich_bt_interfaces__srv__RunNamedCommand_Event__fini(sandwich_bt_interfaces__srv__RunNamedCommand_Event * msg)
{
  ...
  // request
  sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence__fini(&msg->request);
  // response
  sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence__fini(&msg->response);
}
...
sandwich_bt_interfaces__srv__RunNamedCommand_Event__are_equal(const sandwich_bt_interfaces__srv__RunNamedCommand_Event * lhs, const sandwich_bt_interfaces__srv__RunNamedCommand_Event * rhs)
{
  ...
  // request
  if (!sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence__are_equal(
  ...
  sandwich_bt_interfaces__srv__RunNamedCommand_Event * output)
{
  ...
  // request
  if (!sandwich_bt_interfaces__srv__RunNamedCommand_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!sandwich_bt_interfaces__srv__RunNamedCommand_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sandwich_bt_interfaces__srv__RunNamedCommand_Event * msg = (sandwich_bt_interfaces__srv__RunNamedCommand_Event *)allocator.allocate(sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Event));
  bool success = sandwich_bt_interfaces__srv__RunNamedCommand_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence__init(sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sandwich_bt_interfaces__srv__RunNamedCommand_Event * data = NULL;

  if (size) {
    data = (sandwich_bt_interfaces__srv__RunNamedCommand_Event *)allocator.zero_allocate(size, sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sandwich_bt_interfaces__srv__RunNamedCommand_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        sandwich_bt_interfaces__srv__RunNamedCommand_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence__fini(sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      sandwich_bt_interfaces__srv__RunNamedCommand_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence * array = (sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence *)allocator.allocate(sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence__destroy(sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence__are_equal(const sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence * lhs, const sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sandwich_bt_interfaces__srv__RunNamedCommand_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sandwich_bt_interfaces__srv__RunNamedCommand_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sandwich_bt_interfaces__srv__RunNamedCommand_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sandwich_bt_interfaces__srv__RunNamedCommand_Event * data =
      (sandwich_bt_interfaces__srv__RunNamedCommand_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sandwich_bt_interfaces__srv__RunNamedCommand_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sandwich_bt_interfaces__srv__RunNamedCommand_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!sandwich_bt_interfaces__srv__RunNamedCommand_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
