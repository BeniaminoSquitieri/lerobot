...
lerobot_bt_interfaces__srv__GetSkillVerification_Request__init(lerobot_bt_interfaces__srv__GetSkillVerification_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->skill_name)) {
    lerobot_bt_interfaces__srv__GetSkillVerification_Request__fini(msg);
    return false;
  }
  return true;
}
...
lerobot_bt_interfaces__srv__GetSkillVerification_Request__create(void)
{
  ...
  lerobot_bt_interfaces__srv__GetSkillVerification_Request * msg = (lerobot_bt_interfaces__srv__GetSkillVerification_Request *)allocator.allocate(sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Request));
  bool success = lerobot_bt_interfaces__srv__GetSkillVerification_Request__init(msg);
  if (!success) {
...
lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence__init(lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lerobot_bt_interfaces__srv__GetSkillVerification_Request * data = NULL;

  if (size) {
    data = (lerobot_bt_interfaces__srv__GetSkillVerification_Request *)allocator.zero_allocate(size, sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lerobot_bt_interfaces__srv__GetSkillVerification_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        lerobot_bt_interfaces__srv__GetSkillVerification_Request__fini(&data[i - 1]);
      }
...
lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence__fini(lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      lerobot_bt_interfaces__srv__GetSkillVerification_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence * array = (lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence *)allocator.allocate(sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence__init(array, size);
  if (!success) {
...
lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence__destroy(lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence__are_equal(const lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence * lhs, const lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lerobot_bt_interfaces__srv__GetSkillVerification_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lerobot_bt_interfaces__srv__GetSkillVerification_Request * data =
      (lerobot_bt_interfaces__srv__GetSkillVerification_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lerobot_bt_interfaces__srv__GetSkillVerification_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lerobot_bt_interfaces__srv__GetSkillVerification_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!lerobot_bt_interfaces__srv__GetSkillVerification_Request__copy(
...
lerobot_bt_interfaces__srv__GetSkillVerification_Response__init(lerobot_bt_interfaces__srv__GetSkillVerification_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->status)) {
    lerobot_bt_interfaces__srv__GetSkillVerification_Response__fini(msg);
    return false;
  }
  // message
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lerobot_bt_interfaces__srv__GetSkillVerification_Response * msg = (lerobot_bt_interfaces__srv__GetSkillVerification_Response *)allocator.allocate(sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Response));
  bool success = lerobot_bt_interfaces__srv__GetSkillVerification_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence__init(lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lerobot_bt_interfaces__srv__GetSkillVerification_Response * data = NULL;

  if (size) {
    data = (lerobot_bt_interfaces__srv__GetSkillVerification_Response *)allocator.zero_allocate(size, sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lerobot_bt_interfaces__srv__GetSkillVerification_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        lerobot_bt_interfaces__srv__GetSkillVerification_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence__fini(lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      lerobot_bt_interfaces__srv__GetSkillVerification_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence * array = (lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence *)allocator.allocate(sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence__destroy(lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence__are_equal(const lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence * lhs, const lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lerobot_bt_interfaces__srv__GetSkillVerification_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lerobot_bt_interfaces__srv__GetSkillVerification_Response * data =
      (lerobot_bt_interfaces__srv__GetSkillVerification_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lerobot_bt_interfaces__srv__GetSkillVerification_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lerobot_bt_interfaces__srv__GetSkillVerification_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!lerobot_bt_interfaces__srv__GetSkillVerification_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
lerobot_bt_interfaces__srv__GetSkillVerification_Event__init(lerobot_bt_interfaces__srv__GetSkillVerification_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    lerobot_bt_interfaces__srv__GetSkillVerification_Event__fini(msg);
    return false;
  }
  // request
  if (!lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence__init(&msg->request, 0)) {
    lerobot_bt_interfaces__srv__GetSkillVerification_Event__fini(msg);
    return false;
  }
  // response
  if (!lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence__init(&msg->response, 0)) {
    lerobot_bt_interfaces__srv__GetSkillVerification_Event__fini(msg);
    return false;
  }
  return true;
...
lerobot_bt_interfaces__srv__GetSkillVerification_Event__fini(lerobot_bt_interfaces__srv__GetSkillVerification_Event * msg)
{
  ...
  // request
  lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence__fini(&msg->request);
  // response
  lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence__fini(&msg->response);
}
...
lerobot_bt_interfaces__srv__GetSkillVerification_Event__are_equal(const lerobot_bt_interfaces__srv__GetSkillVerification_Event * lhs, const lerobot_bt_interfaces__srv__GetSkillVerification_Event * rhs)
{
  ...
  // request
  if (!lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence__are_equal(
  ...
  lerobot_bt_interfaces__srv__GetSkillVerification_Event * output)
{
  ...
  // request
  if (!lerobot_bt_interfaces__srv__GetSkillVerification_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!lerobot_bt_interfaces__srv__GetSkillVerification_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lerobot_bt_interfaces__srv__GetSkillVerification_Event * msg = (lerobot_bt_interfaces__srv__GetSkillVerification_Event *)allocator.allocate(sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Event));
  bool success = lerobot_bt_interfaces__srv__GetSkillVerification_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence__init(lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lerobot_bt_interfaces__srv__GetSkillVerification_Event * data = NULL;

  if (size) {
    data = (lerobot_bt_interfaces__srv__GetSkillVerification_Event *)allocator.zero_allocate(size, sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lerobot_bt_interfaces__srv__GetSkillVerification_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        lerobot_bt_interfaces__srv__GetSkillVerification_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence__fini(lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      lerobot_bt_interfaces__srv__GetSkillVerification_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence * array = (lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence *)allocator.allocate(sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence__destroy(lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence__are_equal(const lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence * lhs, const lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lerobot_bt_interfaces__srv__GetSkillVerification_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lerobot_bt_interfaces__srv__GetSkillVerification_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lerobot_bt_interfaces__srv__GetSkillVerification_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lerobot_bt_interfaces__srv__GetSkillVerification_Event * data =
      (lerobot_bt_interfaces__srv__GetSkillVerification_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lerobot_bt_interfaces__srv__GetSkillVerification_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lerobot_bt_interfaces__srv__GetSkillVerification_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!lerobot_bt_interfaces__srv__GetSkillVerification_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
